...
public TarjetaCredito(){
    ...
    public TarjetaCredito(int numero, String banco, double balance, double limite, int id, String nombre, String apellido, String email, String contrasenia, int dni, String calle, int depNumero, int piso, String provincia, String departamento, String ciudad, String descripcion, Date fechaCaducidad) {
        this.numero = numero;
        this.banco = banco;
        this.balance = balance;
        this.limite = limite;
        this.usuario = new Usuario(id, nombre, apellido, email, contrasenia, dni, calle, numero, depNumero, piso, provincia, departamento, ciudad, descripcion);
